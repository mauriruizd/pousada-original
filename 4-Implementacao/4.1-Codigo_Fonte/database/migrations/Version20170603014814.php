...
class Version20170603014814 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE usuarios CHANGE login email VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE usuarios CHANGE email login VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
