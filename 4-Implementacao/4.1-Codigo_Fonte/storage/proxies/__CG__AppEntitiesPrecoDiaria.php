 ...
 */
class PrecoDiaria extends \App\Entities\PrecoDiaria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'mes', 'preco', 'deletedAt', 'tipoQuarto'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrecoDiaria $proxy) {
