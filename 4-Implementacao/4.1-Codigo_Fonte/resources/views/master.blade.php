    ...
    <div class="navbar-default sidebar no-print" role="navigation">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="{{ route('fontes-reservas.index') }}" class="waves-effect"><i class="fa fa-sitemap fa-fw" aria-hidden="true"></i><span class="hide-menu">Fontes de Reservas</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('caixas.index') }}" class="waves-effect"><i class="fa fa-dollar fa-fw" aria-hidden="true"></i><span class="hide-menu">Caixa</span></a>
                </li>
                <li>
