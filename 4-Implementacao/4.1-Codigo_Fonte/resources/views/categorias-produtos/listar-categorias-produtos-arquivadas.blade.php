...
@section('content')
        ...
        <table class="table">
            ...
            @foreach($categorias as $categoria)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('categorias-produtos.recuperar', [$categoria->getId()]) }}" class="btn btn-primary">
    ...
    <div class="floating-menu">
        <a href="{{ route('categorias-produtos.index') }}" class="btn btn-primary btn-rounded btn-lg menu-main">
